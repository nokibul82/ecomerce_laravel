    ...
    <div class="flex shadow-md my-10">
      <div class="w-3/4 bg-white px-10 py-10">
        <div class="flex justify-between border-b pb-8">
          ...
          <h2 class="font-semibold text-2xl">{{ $products->count()}} Items</h2>
        </div>
        ...
        <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
          ...
          <div class="flex justify-center w-1/5">
            ...
            <form action="/substract_item" method="POST">
              @csrf
              <input type="hidden" name="cart_id" value={{$product->cart_id}}>
              <button><svg class="fill-current text-gray-600 w-3" viewBox="0 0 448 512">
                <path
                  d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z" />
              </svg></button>
            </form>
            
            <h2 class="mx-2 border text-center w-8">{{ $product->quantity }}</h2>
